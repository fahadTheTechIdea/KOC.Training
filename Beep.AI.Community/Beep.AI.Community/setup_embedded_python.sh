...
cat > python-embedded/.community_protected << EOF
CRITICAL_SYSTEM_COMPONENT
This directory contains the embedded Python runtime required for Beep.AI.Community to function.
...
echo ""
echo "You can now run Beep.AI.Community using ./run.sh or python run_community.py"
echo ""
