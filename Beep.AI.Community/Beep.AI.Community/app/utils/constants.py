...
ENV_RATELIMIT_ENABLED: Final[str] = 'RATELIMIT_ENABLED'
ENV_AISERVER_URL: Final[str] = 'AISERVER_URL'
ENV_AISERVER_API_KEY: Final[str] = 'AISERVER_API_KEY'
ENV_MLSTUDIO_URL: Final[str] = 'MLSTUDIO_URL'

# ==================== Default Values ====================
DEFAULT_SECRET_KEY: Final[str] = 'community-dev-secret-key-change-in-production'
DEFAULT_HOST: Final[str] = '127.0.0.1'
DEFAULT_PORT: Final[int] = 5002
DEFAULT_DATABASE_URL: Final[str] = 'sqlite:///community.db'
...
DEFAULT_MLSTUDIO_URL: Final[str] = 'http://127.0.0.1:5001'
...
DIR_UPLOADS_DATASETS: Final[str] = 'uploads/datasets'
DIR_UPLOADS_NOTEBOOKS: Final[str] = 'uploads/notebooks'
DIR_UPLOADS_SUBMISSIONS: Final[str] = 'uploads/submissions'
